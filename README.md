...
**[ Documentation / 取扱説明書 / 说明书 / 說明書 / 설명서 ]**
Please click the link below for detailed installation instructions and features.

- 🇬🇧 [English Documentation](manual/README_EN.md)
- 🇯🇵 [日本語マニュアル](manual/README_JP.md)
- 🇨🇳 [简体中文 (CH)](manual/README_CH.md)
- 🇹🇼 [繁體中文 (TW)](manual/README_TW.md)
- 🇰🇷 [한국어 설명서](manual/README_KR.md)
